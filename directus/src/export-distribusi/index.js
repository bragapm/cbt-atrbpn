  ...
  router.get("/", async (req, res, next) => {
    try {
      const result = await database.raw(`
            select ms.materi ,ks.nama_kategori AS kategori, ds.jumlah_soal AS total_distribusi, ks.bobot_benar, ks.bobot_salah, ks.tidak_menjawab  from distribusi_soal ds 
